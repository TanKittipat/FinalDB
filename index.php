    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12"> <br>
                <h3>CRUD ข้อมูลการจองคิวสำหรับ จนท.เท่านั้น!!! <a href="AddQueue.php"
                        class="btn btn-info float-end">+เพิ่มข้อมูลการจองคิว</a>
                </h3> <br />
                <table id="PatientTable"
                    ...
                    <tbody>
                        ...
                        require 'conn.php';
                        $query =
                            'SELECT * FROM patient p, queue q WHERE p.Pid = q.Pid';
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td><a href="UpdateQueueForm.php?QDate=<?= $r['QDate'] ?>&QNumber=<?= $r['QNumber'] ?>"
                                        class="btn btn-warning btn-sm">แก้ไข</a></td>
                                <td><a href="DeleteQueue.php?QDate=<?= $r['QDate'] ?>&QNumber=<?= $r['QNumber'] ?>"
